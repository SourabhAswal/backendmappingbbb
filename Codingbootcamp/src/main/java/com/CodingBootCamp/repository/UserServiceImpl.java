...
public class UserServiceImpl implements UserService {
	...
	public String register(User user, String siteURL) {
		...
		int count = 0;
		List<User> userList = userDAO.findByMeetingId(user.getMeeting_id());
	...
	public List<User> getUserById(Long id) {
		...
		List<User> list = userDAO.findByMeetingId(id);
		return list;
	}
	...
	public String login(User user,Long meeting_id) {
		...
		userList =  userDAO.findByMeetingId(meeting_id);
	...
	public void saveLoggedInUser(User user,long meeting_id) {
		...
		int count = 0;
		List<LoggedInUsers> userList = loggedInUsers.findByMeetingId(meeting_id);
		...
		if (count == 0) {
			...
			users.setMeeting_id(user.getMeeting_id());
	...
	public List<LoggedInUsers> getLoggedInUserByMId(Long meeing_id) {
		...
		return loggedInUsers.findByMeetingId(meeing_id);
	}
